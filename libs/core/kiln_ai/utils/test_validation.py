...
class TestValidateReturnDictProp:
    ...
    def test_missing_key_raises_error(self):
        ...
        with pytest.raises(ValueError) as exc_info:
            validate_return_dict_prop(test_dict, "missing_key", str)

        expected_msg = "missing_key is a required property for LanceDB vector store configs and must be of type <class 'str'>"
    ...
    def test_wrong_type_raises_error(self):
        ...
        with pytest.raises(ValueError) as exc_info:
            validate_return_dict_prop(test_dict, "count", int)

        expected_msg = "count is a required property for LanceDB vector store configs and must be of type <class 'int'>"
        assert str(exc_info.value) == expected_msg
    ...
    def test_none_value_with_none_type(self):
        ...
        result = validate_return_dict_prop(test_dict, "value", type(None))
    ...
    def test_none_value_with_string_type_raises_error(self):
        ...
        test_dict = {"value": None}
        with pytest.raises(ValueError) as exc_info:
            validate_return_dict_prop(test_dict, "value", str)

        expected_msg = "value is a required property for LanceDB vector store configs and must be of type <class 'str'>"
        assert str(exc_info.value) == expected_msg
    ...
    def test_various_types_succeed(self, test_value, expected_type):
        ...
        result = validate_return_dict_prop(test_dict, "value", expected_type)
        assert result == test_value
    ...
    def test_various_types_fail(self, test_value, wrong_type):
        ...
        with pytest.raises(ValueError):
            validate_return_dict_prop(test_dict, "value", wrong_type)

    def test_empty_dict_raises_error(self):
        """Test that empty dictionary raises error for any key."""
        test_dict = {}
        with pytest.raises(ValueError) as exc_info:
            validate_return_dict_prop(test_dict, "any_key", str)

        expected_msg = "any_key is a required property for LanceDB vector store configs and must be of type <class 'str'>"
        assert str(exc_info.value) == expected_msg

    def test_empty_string_key(self):
        """Test validation with empty string as key."""
        test_dict = {"": "empty_key_value"}
        result = validate_return_dict_prop(test_dict, "", str)
    ...
    def test_numeric_values_and_inheritance(self):
        ...
        test_dict = {"flag": True}
        result = validate_return_dict_prop(test_dict, "flag", int)
        assert result is True
...
class TestValidateReturnDictPropOptional:
    ...
    def test_valid_string_property(self):
        """Test validation succeeds for valid string property."""
        test_dict = {"name": "test_value"}
        result = validate_return_dict_prop_optional(test_dict, "name", str)
        assert result == "test_value"

    def test_valid_int_property(self):
        """Test validation succeeds for valid integer property."""
        test_dict = {"count": 42}
        result = validate_return_dict_prop_optional(test_dict, "count", int)
        assert result == 42

    def test_missing_key_returns_none(self):
        """Test that missing key returns None instead of raising error."""
        test_dict = {"other_key": "value"}
        result = validate_return_dict_prop_optional(test_dict, "missing_key", str)
        assert result is None

    def test_none_value_returns_none(self):
        """Test that None value returns None."""
        test_dict = {"value": None}
        result = validate_return_dict_prop_optional(test_dict, "value", str)
        assert result is None

    def test_empty_dict_returns_none(self):
        """Test that empty dictionary returns None for any key."""
        test_dict = {}
        result = validate_return_dict_prop_optional(test_dict, "any_key", str)
        assert result is None
    ...
    def test_wrong_type_raises_error(self):
        ...
        test_dict = {"count": "not_a_number"}
        with pytest.raises(ValueError) as exc_info:
            validate_return_dict_prop_optional(test_dict, "count", int)
    ...
    def test_explicit_none_vs_missing_key(self):
        ...
        result_missing = validate_return_dict_prop_optional(
            test_dict_missing, "target", str
        )
        assert result_missing is None

        # Explicit None
        test_dict_none = {"target": None}
        result_none = validate_return_dict_prop_optional(test_dict_none, "target", str)
    ...
    def test_various_types_succeed(self, test_value, expected_type):
        """Test validation succeeds for various types."""
        test_dict = {"value": test_value}
        result = validate_return_dict_prop_optional(test_dict, "value", expected_type)
        assert result == test_value
        assert isinstance(result, expected_type)
    ...
    def test_various_types_fail(self, test_value, wrong_type):
        ...
        test_dict = {"value": test_value}
        with pytest.raises(ValueError):
            validate_return_dict_prop_optional(test_dict, "value", wrong_type)

    def test_empty_string_key_with_value(self):
        """Test validation with empty string as key when value exists."""
        test_dict = {"": "empty_key_value"}
        result = validate_return_dict_prop_optional(test_dict, "", str)
        assert result == "empty_key_value"
    ...
    def test_numeric_inheritance_behavior(self):
        ...
        # bool is a subclass of int in Python, so True/False are valid ints
        test_dict = {"flag": True}
        result = validate_return_dict_prop_optional(test_dict, "flag", int)
        assert result is True
    ...
    def test_optional_with_zero_values(self):
        ...
        for test_dict, key, expected_type, expected_value in test_cases:
            result = validate_return_dict_prop_optional(test_dict, key, expected_type)

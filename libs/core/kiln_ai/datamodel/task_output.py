...
class DataSource(BaseModel):
    ...
    run_config: Optional[RunConfigProperties] = Field(
        default=None,
        description="The run config used to generate the data, if generated by a running a model in Kiln (only true for type=synthetic/tool_call).",
    )
    ...
    _data_source_properties = [
        ...
        DataSourceProperty(
            name="tool_id",
            type=str,
            required_for=[DataSourceType.tool_call],
            not_allowed_for=[
                DataSourceType.human,
                DataSourceType.synthetic,
                DataSourceType.file_import,

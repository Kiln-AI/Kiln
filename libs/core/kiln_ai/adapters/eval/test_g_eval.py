...
@pytest.mark.paid
async def test_run_g_eval_tool_call_list_evaluation_data_type(
    test_task, test_run_config, test_task_run, tmp_path
):
    """Test G-Eval run_eval with tool_call_list evaluation data type"""
    ...
    # Add trace data with tool calls to the task run
    test_task_run.trace = [

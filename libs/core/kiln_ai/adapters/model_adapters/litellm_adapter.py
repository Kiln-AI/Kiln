    ...
    async def _run(
        ...
        while True:
            ...
            for message in turn.messages:
                ...
                messages_internal.append(chat_message_to_dict(message))  # type: ignore
            ...
            # Update messages_internal in place from turn_result so trace_ref
            # stays in sync (required by the base adapter error-wrapping contract).
            messages_internal[:] = turn_result.all_messages
            ...
            if turn_result.interrupted_by_tool_calls:
                trace = self.all_messages_to_trace(
                    messages_internal, message_latency, message_usage
                )

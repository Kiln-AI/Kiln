...
Run `.config/utils/setup_env.sh --human` — it installs project dependencies and then offers to set up workspaces (worktrunk, Zellij, and config). Without `--human` the script is non-interactive and skips the workspace tools.

  ...
  >
    ...
    <g clip-path="url(#canvas-clip)">
      ...
      <g id="check1" opacity="0" transform-origin="379 46.8">
        <g transform="scale(0.5) translate(379, 46.8)">
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
        ...
        <g id="check2" opacity="0" transform-origin="379 104.8">
          <g transform="scale(0.5) translate(379, 104.8)">
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
        ...
        <g id="x1" opacity="0" transform-origin="379 163">
          <g transform="scale(0.5) translate(379, 163)">
            <path
        ...
        <g id="check3" opacity="0" transform-origin="379 220.8">
          <g transform="scale(0.5) translate(379, 220.8)">
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
        ...
        <g id="check4" opacity="0" transform-origin="379 278.8">
          <g transform="scale(0.5) translate(379, 278.8)">
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
        ...
        <g id="check5" opacity="0" transform-origin="379 336.8">
          <g transform="scale(0.5) translate(379, 336.8)">
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
        ...
        <g id="x2" opacity="0" transform-origin="379 395">
          <g transform="scale(0.5) translate(379, 395)">
            <path
        ...
        <g id="x3" opacity="0" transform-origin="379 453">
          <g transform="scale(0.5) translate(379, 453)">
            <path

<script lang="ts">
  ...
  $: agentInfo.set({
    ...
    description: `Compare run configurations for eval ID ${eval_id}, spec ID ${spec_id} in project ID ${project_id}, task ID ${task_id}. Side-by-side comparison of eval results across configurations.`,
  })

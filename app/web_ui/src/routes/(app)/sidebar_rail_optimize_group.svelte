...
<SidebarRailItem
  ...
  active={section === Section.Prompts}
  label="Prompts"
>
  <svg
    slot="icon"
...
<SidebarRailItem
  ...
  active={section === Section.Documents}
  label="Docs & Search"
>
  <div slot="icon" class="w-full h-full">
...
<SidebarRailItem
  ...
  active={section === Section.FineTune}
  label="Fine Tune"
>
  <div slot="icon" class="w-full h-full">
    <FinetuneIcon />

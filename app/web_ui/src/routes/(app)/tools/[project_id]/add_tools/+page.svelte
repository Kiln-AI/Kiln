<script lang="ts">
  ...
  function connectRemoteMcp(item: RemoteMcpServer) {
    goto(`/tools/${project_id}/add_tools/remote_mcp`, {
      state: {
  ...
  function connectLocalMcp(item: LocalMcpServer) {
    goto(`/tools/${project_id}/add_tools/local_mcp`, {
      state: {
        name: item.name + " " + item.subtitle,
        description: item.description,
      ...
      <KilnSection
        ...
        items={[
          ...
          },
          {
            ...
            button_text: "Connect",
            on_click: () => goto(`/tools/${project_id}/add_tools/remote_mcp`),
          },
          {
            type: "settings",
            ...
            button_text: "Connect",
            on_click: () => goto(`/tools/${project_id}/add_tools/local_mcp`),
          },
        ]}
      />
    </div>

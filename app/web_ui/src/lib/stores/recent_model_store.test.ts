...
describe("recent_model_store", () => {
  ...
  describe("store initialization", () => {
    ...
    it("should work with the store after initialization", () => {
      ...
      recent_model_store.set([
        { model_id: "test", model_provider: "test-provider", provider_display_name: null },
      ])
      const models = get(recent_model_store)
      expect(models).toEqual([
        { model_id: "test", model_provider: "test-provider", provider_display_name: null },
  ...
  describe("addRecentModel function", () => {
    ...
    it("should add a new model to empty store", () => {
      ...
      const models = get(recent_model_store)
      expect(models).toEqual([{ model_id: "gpt-4", model_provider: "openai", provider_display_name: null }])
    })
    ...
    it("should add multiple models in MRU order (most recent first)", () => {
      ...
      const models = get(recent_model_store)
      expect(models).toEqual([
        { model_id: "gemini-pro", model_provider: "google", provider_display_name: null },
        { model_id: "claude-3", model_provider: "anthropic", provider_display_name: null },
        { model_id: "gpt-4", model_provider: "openai", provider_display_name: null },
      ])
    })
    ...
    it("should maintain uniqueness - remove duplicate and add to front", () => {
      ...
      const models = get(recent_model_store)
      expect(models).toEqual([
        { model_id: "gpt-4", model_provider: "openai", provider_display_name: null }, // Moved to front
        { model_id: "gemini-pro", model_provider: "google", provider_display_name: null },
        { model_id: "claude-3", model_provider: "anthropic", provider_display_name: null },
      ])
    ...
    it("should differentiate models by both model_id and model_provider", () => {
      ...
      const models = get(recent_model_store)
      expect(models).toEqual([
        { model_id: "gpt-4", model_provider: "azure", provider_display_name: null },
        { model_id: "gpt-4", model_provider: "openai", provider_display_name: null },
      ])
    ...
    it("should maintain maximum of 5 models", () => {
      ...
      expect(models).toEqual([
        { model_id: "model-6", model_provider: "provider-6", provider_display_name: null },
        { model_id: "model-5", model_provider: "provider-5", provider_display_name: null },
        { model_id: "model-4", model_provider: "provider-4", provider_display_name: null },
        { model_id: "model-3", model_provider: "provider-3", provider_display_name: null },
        { model_id: "model-2", model_provider: "provider-2", provider_display_name: null },
      ])
    ...
    it("should handle adding duplicate when at max capacity", () => {
      ...
      expect(models).toHaveLength(5)
      expect(models).toEqual([
        { model_id: "model-3", model_provider: "provider-3", provider_display_name: null }, // Moved to front
        { model_id: "model-5", model_provider: "provider-5", provider_display_name: null },
        { model_id: "model-4", model_provider: "provider-4", provider_display_name: null },
        { model_id: "model-2", model_provider: "provider-2", provider_display_name: null },
        { model_id: "model-1", model_provider: "provider-1", provider_display_name: null },
      ])
    })
    ...
    it("should persist data through store operations", () => {
      ...
      expect(models[0]).toEqual({ model_id: "gpt-4", model_provider: "openai", provider_display_name: null })
    })
  })
  ...
  describe("integration scenarios", () => {
    ...
    it("should handle typical user workflow", () => {
      ...
      const models = get(recent_model_store)
      expect(models).toEqual([
        { model_id: "claude-3-opus", model_provider: "anthropic", provider_display_name: null },
        { model_id: "gemini-pro", model_provider: "google", provider_display_name: null },
        { model_id: "gpt-4", model_provider: "openai", provider_display_name: null }, // Moved up from being reused
        { model_id: "claude-3-sonnet", model_provider: "anthropic", provider_display_name: null },
        { model_id: "gpt-3.5-turbo", model_provider: "openai", provider_display_name: null },
      ])
    })
    ...
    it("should maintain correct order after multiple operations", () => {
      ...
      expect(models).toEqual([
        { model_id: "model-4", model_provider: "provider-4", provider_display_name: null }, // Moved to front
        { model_id: "model-7", model_provider: "provider-7", provider_display_name: null },
        { model_id: "model-6", model_provider: "provider-6", provider_display_name: null },
        { model_id: "model-5", model_provider: "provider-5", provider_display_name: null },
        { model_id: "model-3", model_provider: "provider-3", provider_display_name: null },
      ])

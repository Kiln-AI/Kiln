...
export type KilnToolDescription = components["schemas"]["KilnToolDescription"]
export type ExternalTool = components["schemas"]["ExternalTool"]
export type ToolType = components["schemas"]["ToolType"]

...
export interface paths {
  ...
  "/api/projects/{project_id}/available_task_tools": {
    parameters: {
      query?: never
      header?: never
      path?: never
     ...
     * @description Get all tasks in a project that can be used as tools.
     */
    get: operations["get_available_task_tools_api_projects__project_id__available_task_tools_get"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/api/projects/{project_id}/tasks/{task_id}/tool_info": {
    parameters: {
      query?: never
      header?: never
      path?: never
    ...
    /**
     * Get Task Tool Info
     * @description Get information about a specific task as a tool.
     */
    get: operations["get_task_tool_info_api_projects__project_id__tasks__task_id__tool_info_get"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/api/projects/{project_id}/tasks/{task_id}/test_as_tool": {
    parameters: {
      query?: never
      header?: never
      path?: never
    ...
    /**
     * Test Task As Tool
     * @description Test a task as a tool with sample input.
     */
    post: operations["test_task_as_tool_api_projects__project_id__tasks__task_id__test_as_tool_post"]
    delete?: never
    options?: never
    head?: never
    patch?: never
...
export interface components {
  schemas: {
    ...
    /**
     * TaskToolInfo
     * @description Information about a task that can be used as a tool.
     */
    TaskToolInfo: {
      /** Task Id */
      task_id: string
...
export interface operations {
  ...
  get_available_task_tools_api_projects__project_id__available_task_tools_get: {
    parameters: {
      query?: never
      header?: never
      path: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["TaskToolInfo"][]
        }
      }
      /** @description Validation Error */
      422: {
  ...
  get_task_tool_info_api_projects__project_id__tasks__task_id__tool_info_get: {
    parameters: {
      query?: never
      header?: never
      path: {
  ...
  test_task_as_tool_api_projects__project_id__tasks__task_id__test_as_tool_post: {
    parameters: {
      query?: never
      header?: never
      path: {

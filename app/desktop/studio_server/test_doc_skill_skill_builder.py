...
class TestGenerateSkillDescription:
    ...
    def test_without_tags(self):
        ...
        result = self.builder._generate_skill_description(5)
        assert result == "Document skill generated by Kiln from 5 documents"

    def test_with_tags(self):
        self.builder.doc_skill.document_tags = ["api", "docs"]
        result = self.builder._generate_skill_description(3)
        assert (
            result == "Document skill generated by Kiln from documents tagged api, docs"
        )
    ...
    def test_long_tags_truncation(self):
        ...
        result = self.builder._generate_skill_description(10)
        ...
        with patch.object(builder, "_collect_document_chunks", return_value=doc_chunks):
            with patch.object(
                ...
                with patch.object(builder, "_build_skill_md", return_value="# Skill"):
                    with patch.object(
                        builder, "_generate_skill_description", return_value="desc"
                    ):
...
class TestBuildIntegration:
    ...
    async def test_full_build(self, mock_project, config):
        ...
        assert "1 document" in skill.description

...
from kiln_ai.datamodel.spec import (
    SyntheticDataGenerationSessionConfig as SpecSyntheticDataGenerationSessionConfig,
)
from kiln_ai.datamodel.spec import (
    SyntheticDataGenerationStepConfig as SpecSyntheticDataGenerationStepConfig,
)
...
class CreateSpecWithCopilotRequest(BaseModel):
    ...
    judge_info: SyntheticDataGenerationStepConfig
...
def connect_copilot_api(app: FastAPI):
    ...
    async def clarify_spec(input: ClarifySpecInput) -> ClarifySpecOutput:
    ...
    async def refine_spec(input: RefineSpecInput) -> RefineSpecOutput:
        api_key = get_copilot_api_key()
        client = get_authenticated_client(api_key)
    ...
    async def generate_batch(input: GenerateBatchInput) -> GenerateBatchOutput:
        api_key = get_copilot_api_key()
        client = get_authenticated_client(api_key)
    ...
    async def create_spec_with_copilot(
        ...
        spec = Spec(
            ...
            synthetic_data_generation_session_config=SpecSyntheticDataGenerationSessionConfig(
                topic_generation_config=SpecSyntheticDataGenerationStepConfig(
                ...
                input_generation_config=SpecSyntheticDataGenerationStepConfig(
                ...
                output_generation_config=SpecSyntheticDataGenerationStepConfig(

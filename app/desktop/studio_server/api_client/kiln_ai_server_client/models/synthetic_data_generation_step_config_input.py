...
T = TypeVar("T", bound="SyntheticDataGenerationStepConfigInput")
...
class SyntheticDataGenerationStepConfigInput:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        synthetic_data_generation_step_config_input = cls(
            task_metadata=task_metadata,
            prompt=prompt,
        )

        synthetic_data_generation_step_config_input.additional_properties = d
        return synthetic_data_generation_step_config_input

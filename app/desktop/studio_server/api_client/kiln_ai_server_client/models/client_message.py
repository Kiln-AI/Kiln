...
if TYPE_CHECKING:
    ...
    from ..models.client_message_tool_calls_type_0_item import ClientMessageToolCallsType0Item
...
class ClientMessage:
    ...
    Attributes:
        ...
        tool_calls (list[ClientMessageToolCallsType0Item] | None | Unset):
    """
    ...
    tool_calls: list[ClientMessageToolCallsType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_tool_calls(data: object) -> list[ClientMessageToolCallsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for tool_calls_type_0_item_data in _tool_calls_type_0:
                    tool_calls_type_0_item = ClientMessageToolCallsType0Item.from_dict(tool_calls_type_0_item_data)
                ...
                pass
            return cast(list[ClientMessageToolCallsType0Item] | None | Unset, data)

...
class GenerateBatchOutputDataByTopic:
    ...
    additional_properties: dict[str, list[Sample]] = _attrs_field(init=False, factory=dict)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for prop_name, prop_dict in d.items():
            ...
            for additional_property_item_data in _additional_property:
                additional_property_item = Sample.from_dict(additional_property_item_data)
    ...
    def __getitem__(self, key: str) -> list[Sample]:
        return self.additional_properties[key]

    def __setitem__(self, key: str, value: list[Sample]) -> None:

...
if TYPE_CHECKING:
    ...
    from ..models.eval_item_source import EvalItemSource
...
class TaskRun:
    ...
    repair information if the output needed correction.
        ...
        Attributes:
            ...
            eval_source (EvalItemSource | None | Unset): Set when this run was generated by an eval. Names the eval dataset
                item it was generated for. None for ordinary dataset runs. Runs with this set are excluded from Task.runs() by
                default, so they do not appear on dataset surfaces.
    """
    ...
    eval_source: EvalItemSource | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        eval_source: dict[str, Any] | None | Unset
        if isinstance(self.eval_source, Unset):
            eval_source = UNSET
        elif isinstance(self.eval_source, EvalItemSource):
            eval_source = self.eval_source.to_dict()
        else:
        ...
        if eval_source is not UNSET:
            field_dict["eval_source"] = eval_source
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_eval_source(data: object) -> EvalItemSource | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                eval_source_type_0 = EvalItemSource.from_dict(data)

                return eval_source_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(EvalItemSource | None | Unset, data)

        eval_source = _parse_eval_source(d.pop("eval_source", UNSET))

...
if TYPE_CHECKING:
    from ..models.data_guide_job_output import DataGuideJobOutput
    from ..models.output_file_info import OutputFileInfo


T = TypeVar("T", bound="DataGuideJobResultResponse")


@_attrs_define
class DataGuideJobResultResponse:
    """Response model for data guide job result.

    Attributes:
        status (JobStatus): Job execution status aligned with Google Cloud Run Job execution states.
        output (DataGuideJobOutput | None | Unset):
        output_files (list[OutputFileInfo] | Unset):
    """

    status: JobStatus
    output: DataGuideJobOutput | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.output, Unset):
            output = UNSET
        elif isinstance(self.output, DataGuideJobOutput):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_output(data: object) -> DataGuideJobOutput | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                output_type_0 = DataGuideJobOutput.from_dict(data)

                return output_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DataGuideJobOutput | None | Unset, data)
        ...
        data_guide_job_result_response = cls(
            status=status,
            output=output,
            output_files=output_files,
        )

        data_guide_job_result_response.additional_properties = d
        return data_guide_job_result_response

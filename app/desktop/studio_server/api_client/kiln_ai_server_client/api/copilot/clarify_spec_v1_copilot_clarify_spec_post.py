...
) -> ClarifySpecOutput | HTTPValidationError | UnauthorizedResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClarifySpecOutput | HTTPValidationError | UnauthorizedResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ClarifySpecOutput | HTTPValidationError | UnauthorizedResponse
    """

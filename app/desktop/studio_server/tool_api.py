...
def connect_tool_servers_api(app: FastAPI):
    @app.get("/api/projects/{project_id}/available_tools", openapi_extra=ALLOW_AGENT)
    ...
    @app.get(
        "/api/projects/{project_id}/available_tool_servers", openapi_extra=ALLOW_AGENT
    )
    ...
    @app.get("/api/projects/{project_id}/kiln_task_tools", openapi_extra=ALLOW_AGENT)
    ...
    @app.post("/api/projects/{project_id}/connect_remote_mcp", openapi_extra=DENY_AGENT)
    ...
    @app.post("/api/projects/{project_id}/connect_local_mcp", openapi_extra=DENY_AGENT)
    ...
    @app.post("/api/projects/{project_id}/kiln_task_tool", openapi_extra=DENY_AGENT)

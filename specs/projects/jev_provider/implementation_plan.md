...
- [ ] Phase 2: The standalone `jev_jsonschema` package (wire models, `JSONSchema2Jev`, `JevResult2JsonSchema`, README, isolation test) and the `JevClient` on top of it, per the two component docs. No Kiln imports inside the package.

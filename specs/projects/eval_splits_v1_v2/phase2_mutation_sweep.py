...
JFB_API = "app/desktop/studio_server/judge_feedback_batch_api.py"
JFB_WORKER = "app/desktop/studio_server/jobs/workers/judge_feedback_batch.py"
...
TJFB = (
    "app/desktop/studio_server/test_judge_feedback_batch_api.py "
...
MUTATIONS = [
    ...
    (
        "judge guard: v2 rejection removed",
        JFB_API,
    ...
    (
        "judge worker: guard call removed",
        JFB_WORKER,
